                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4">
                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                            <input name="date_start" type="text" class="form-control datetimepicker-input" data-target="#reservationdate" required value="{{ $transaction->date_start ? date('m/d/Y', strtotime($transaction->date_start)) : '' }}" />
                    ...
                    <div class="col-lg-4">
                        <div class="input-group date" id="pinjam_selesai" data-target-input="nearest">
                            <input name="date_end" type="text" class="form-control datetimepicker-input" data-target="#pinjam_selesai" required value="{{ $transaction->date_end ? date('m/d/Y', strtotime($transaction->date_end)) : '' }}" />
                    ...
                    <div class="col-lg-10">
                        <select name="book_id[]" class="select2" multiple="multiple" data-placeholder="Pilih Buku" style="width: 100%;" required>
                            @foreach($books as $book)
                                <option value="{{ $book->id }}" {{ in_array($book->id, $transaction->transactionDetails->pluck('book_id')->toArray()) ? 'selected' : '' }}>
                                    {{ $book->title }}
                                </option>
                            @endforeach
                        </select>                                               
